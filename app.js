...
app.get('/Ocorrencia_Listar', (req, res) => {
  ...
  // Criar Salas
app.get('/Salas_Create', (req, res) => {
    res.render('Salas_Create', {
        title: 'Editar Paciente',
        esconderHeader: false 
    });
  });
...
// Editar Salas
  app.get('/Salas_Editar', (req, res) => {
    res.render('Salas_Editar', {
        title: 'Editar Paciente',
        esconderHeader: false 
    });
  });
...
// Listar Salas
  app.get('/Salas_Listar', (req, res) => {
    res.render('Salas_Listar', {
        title: 'Editar Paciente',
        esconderHeader: false 
    });
  });
  ...
  // Encaminhaar Editar
  app.get('/Encaminhamento_Edit', (req, res) => {
    res.render('Encaminhamento_Edit', {
        title: 'Editar Paciente',
        esconderHeader: false 
    });
  });
   // EncaminhaR Listar
   app.get('/Encaminhamento_Listar', (req, res) => {
    res.render('Encaminhamento_Listar', {
        title: 'Editar Paciente',
        esconderHeader: false 
    });
  });
